...
python hsi_denoising_test.py -a $modelname -p hypersigma_gaussian -r -rp $weight_path --testdir  ./data/HSI_Data/Hyperspectral_Project/WDC/test_noise/Patch_Cases/Case4  --basedir output/test --pretrain_path /home/lofty/CODE/HyperSIGMA-fork/spat-base.pth